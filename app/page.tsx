    ...
    <div className="relative container mx-auto px-4 pt-16 pb-16">
      ...
      <div className="max-w-5xl mx-auto text-center space-y-8">
        <h1 className="text-4xl md:text-6xl lg:text-7xl gradient-title mb-6">
          Your Space to StoryLens. <br /> Your Story to Tell.
        </h1>
      ...
      >
        ...
        {/* Features details */}
      <div className="space-y-24 mt-24 px-4">
        {/* Feature 1 */}
        ...
        <Card className="bg-gradient-to-r from-orange-100 to-amber-100">
          <CardContent className="p-12 text-center">
            ...
            <Button size="lg" variant="journal" className="animate-bounce">
              <Link href="/dashboard" className="flex items-center">Get Started for Free <ChevronRight className="ml-2 h-4 w-4" /></Link>
            </Button>
          </CardContent>
        </Card>
      </div>
